  ...
  void _processAndAddTags(String input, StateSetter setState) {
    ...
    for (final tag in tags) {
      ...
      if (!_currentTags.contains(normalizedTag) &&
          !_tagsToAdd.contains(normalizedTag)) {
        setState(() {
              ...
              if (event.logicalKey == LogicalKeyboardKey.tab) {
                if (currentTagText.isNotEmpty) {
                  if (suggestions.isNotEmpty) {
                    ...
                    if (lastCommaIndex >= 0) {
                      final tagsBeforeCurrent =
                          fullText.substring(0, lastCommaIndex);
                          ...
                          .map((tag) => GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: primaryGradientTop),
                                  ),
                                  child: Text(
                                    tag,
...
class _ReorderableTagWrap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final visibleCurrentTags =
        currentTags.where((tag) => !tagsToRemove.contains(tag)).toList();
